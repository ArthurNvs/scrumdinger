...
//  Scrumdinger
//
//  Created by Arthur Neves on 29/10/21.
//
        ...
        ZStack {
            ...
            VStack {
                ...
                Image(systemName: isRecording ? "mic" : "mic.slash")
                    .font(.title)
                    .padding(.top)
                    .accessibilityLabel(isRecording ? "with transcription" : "wihtou transcription")
            }
...
struct MeetingTimerView_Previews: PreviewProvider {
    static var speakers = [ScrumTimer.Speaker(name: "John", isCompleted: true), ScrumTimer.Speaker(name: "Alice", isCompleted: false)]
